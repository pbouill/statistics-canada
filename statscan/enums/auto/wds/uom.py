...
#     date: 2025-09-05T16:48:22.369569+00:00

from enum import Enum


class Uom(Enum):
    """Statistics Canada Uom codes"""
    ...
    DOLLARS_PER_PPL = 118  # (Dollars per person) {'memberUomFr': 'Dollars par personne'}
    ...
    DOZENS_PER_PPL_PER_YEAR = 130  # (Dozens per person, per year) {'memberUomFr': 'Douzaines par personne, par année'}
    DURATION = 131  # (Duration) {'memberUomFr': 'Durée'}
    EGGS = 132  # (Eggs) {'memberUomFr': 'Oeufs'}
    EMPL = 133  # (Employees) {'memberUomFr': 'Employés'}
    EMPL_1 = 134  # (Employees) {'memberUomFr': 'Travailleurs'}
    ENT = 135  # (Enterprises) {'memberUomFr': 'Entreprises'}
    ESTABLISHMENTS = 136  # (Establishments) {'memberUomFr': 'Établissements'}
    EVENINGS = 137  # (Evenings) {'memberUomFr': 'Soirées'}
    FAM = 138  # (Families) {'memberUomFr': 'Familles'}
    ...
    FGN_BORN_PPL = 140  # (Foreign-born persons) {'memberUomFr': "Personnes nées à l'étranger"}
    ...
    GIGAJOULES_PER_THOUSAND_CURRENT_DOLLARS_OF_PROD = 144  # (Gigajoules per thousand current dollars of production) {'memberUomFr': 'Gigajoules par millier de dollars courants de production'}
    ...
    HH = 154  # (Households) {'memberUomFr': 'Ménages'}
    ...
    IDX = 160  # (Index) {'memberUomFr': 'Indice'}
    IDX_1926_100 = 161  # (Index, 1926=100) {'memberUomFr': 'Indice, 1926=100'}
    IDX_1948_100_1968_100 = 162  # (Index, 1948=100/1968=100) {'memberUomFr': 'Indices, 1948=100/1968=100'}
    IDX_1961_100 = 163  # (Index, 1961=100) {'memberUomFr': 'Indice, 1961=100'}
    IDX_1967_100 = 164  # (Index, 1967=100) {'memberUomFr': 'Indice, 1967=100'}
    IDX_1971_100 = 165  # (Index, 1971=100) {'memberUomFr': 'Indice, 1971=100'}
    IDX_1972_100 = 166  # (Index, 1972=100) {'memberUomFr': 'Indice, 1972=100'}
    IDX_1975_1000 = 167  # (Index, 1975=1000) {'memberUomFr': 'Indice, 1975=1000'}
    IDX_1977_100 = 168  # (Index, 1977=100) {'memberUomFr': 'Indice, 1977=100'}
    IDX_1981_100 = 169  # (Index, 1981=100) {'memberUomFr': 'Indice, 1981=100'}
    _2002_100 = 17  # (2002=100) {'memberUomFr': '2002=100'}
    IDX_1982_84_100 = 170  # (Index, 1982-84=100) {'memberUomFr': 'Indice, 1982-84=100'}
    IDX_1986_100 = 171  # (Index, 1986=100) {'memberUomFr': 'Indice, 1986=100'}
    IDX_1990_100 = 172  # (Index, 1990=100) {'memberUomFr': 'Indice, 1990=100'}
    IDX_1992_100 = 173  # (Index, 1992=100) {'memberUomFr': 'Indice, 1992=100'}
    IDX_199712_100 = 174  # (Index, 199712=100) {'memberUomFr': 'Indice, 199712=100'}
    IDX_1997_100 = 175  # (Index, 1997=100) {'memberUomFr': 'Indice, 1997=100'}
    IDX_2000_1000 = 176  # (Index, 2000=1000) {'memberUomFr': 'Indice, 2000=1000'}
    IDX_2001_100 = 177  # (Index, 2001=100) {'memberUomFr': 'Indice, 2001=100'}
    IDX_2002_100 = 178  # (Index, 2002=100) {'memberUomFr': 'Indice, 2002=100'}
    IDX_2003_100 = 179  # (Index, 2003=100) {'memberUomFr': 'Indice, 2003=100'}
    _2007_CONSTANT_DOLLARS = 18  # (2007 constant dollars) {'memberUomFr': 'Dollars constants de 2007'}
    IDX_2006_100 = 180  # (Index, 2006=100) {'memberUomFr': 'Indice, 2006=100'}
    IDX_2007_100 = 181  # (Index, 2007=100) {'memberUomFr': 'Indice, 2007=100'}
    IDX_2008_100 = 182  # (Index, 2008=100) {'memberUomFr': 'Indice, 2008=100'}
    IDX_2009_100 = 183  # (Index, 2009=100) {'memberUomFr': 'Indice, 2009=100'}
    IDX_2010_100 = 184  # (Index, 2010=100) {'memberUomFr': 'Indice, 2010=100'}
    IDX_2011_100 = 185  # (Index, 2011=100) {'memberUomFr': 'Indice, 2011=100'}
    IDX_2013_100 = 186  # (Index, 2013=100) {'memberUomFr': 'Indice, 2013=100'}
    IDX_82_90_100 = 187  # (Index, 82-90=100) {'memberUomFr': 'Indice, 82-90=100'}
    IDX_COMBINED_CITY_AVG_100 = 188  # (Index, combined city average=100) {'memberUomFr': 'Indice, moyenne des villes combinées=100'}
    IDX1992_100 = 189  # (Index,1992=100) {'memberUomFr': 'Indice, 1992=100'}
    ...
    KILOGRAMS_PER_PPL_PER_YEAR = 194  # (Kilograms per person, per year) {'memberUomFr': 'Kilogrammes par personne, par année'}
    ...
    LITRES_ABSOLUTE_ALC = 204  # (Litres absolute alcohol) {'memberUomFr': "Litres d'alcool absolu"}
    LITRES_PER_PPL_PER_YEAR = 205  # (Litres per person, per year) {'memberUomFr': 'Litres par personne, par année'}
    ...
    MEAN_NUM = 207  # (Mean number) {'memberUomFr': 'Nombre moyen'}
    ...
    NATL_CURRENCY_PER_CAN_DOLLAR = 222  # (National currency per Canadian dollar) {'memberUomFr': 'Monnaie nationale par dollar canadien'}
    NUM = 223  # (Number) {'memberUomFr': 'Nombre'}
    NIACIN_EQUIVALENT = 224  # (Niacin equivalent) {'memberUomFr': 'Équivalent en niacine'}
    NIGHTS = 225  # (Nights) {'memberUomFr': 'Nuitées'}
    NUM_IN_THOUSANDS = 226  # (Number in thousands) {'memberUomFr': 'Nombre en milliers'}
    NUM_OF_FARMS_REP = 227  # (Number of farms reporting) {'memberUomFr': "Nombre d'exploitations déclarantes"}
    NUM_OF_VISITS = 228  # (Number of visits) {'memberUomFr': 'Nombre de visites'}
    NUM_PER_SQUARE_KILOMETRE = 229  # (Number per square kilometre) {'memberUomFr': 'Nombre par kilomètre carré'}
    _2012_CONSTANT_DOLLARS = 23  # (2012 constant dollars) {'memberUomFr': 'Dollars constants de 2012'}
    OTHER_BRITISH_AND_FGN_BORN_PPL = 230  # (Other British- and foreign-born persons) {'memberUomFr': "Personnes nées dans un autre pays britannique et à l'étranger"}
    OTHER_BRITISH_BORN_PPL = 231  # (Other British-born persons) {'memberUomFr': 'Personnes nées dans un autre pays britannique'}
    ...
    PASS_KILOMETRES = 234  # (Passenger-kilometres) {'memberUomFr': 'Passagers-kilomètres'}
    PASS_KILOMETRES_1 = 235  # (Passenger-kilometres) {'memberUomFr': 'Voyageur-kilomètres'}
    PASS = 236  # (Passengers) {'memberUomFr': 'Passagers'}
    PASS_1 = 237  # (Passengers) {'memberUomFr': 'Voyageurs'}
    PASS_MILES = 238  # (Passengers-miles) {'memberUomFr': 'Voyageurs-mille'}
    PERCENT = 239  # (Percent) {'memberUomFr': 'Pourcent'}
    _2012_01_100 = 24  # (2012/01=100) {'memberUomFr': '2012/01=100'}
    PERCENT_CHANGE = 240  # (Percent change (1986=100)) {'memberUomFr': 'Variation en pourcentage (1986=100)'}
    ...
    PERCENTAGE_OF_GROSS_DOM_INC = 243  # (Percentage of gross domestic income) {'memberUomFr': 'Pourcentage du revenu intérieur brut'}
    PERCENTAGE_OF_GDP = 244  # (Percentage of gross domestic product) {'memberUomFr': 'Pourcentage du produit intérieur brut'}
    PERCENTAGE_OF_HH = 245  # (Percentage of households) {'memberUomFr': 'Pourcentage des ménages'}
    PERCENTAGE_SHARE = 246  # (Percentage share) {'memberUomFr': 'Part en pourcentage'}
    PPL_TRIPS = 247  # (Person-trips) {'memberUomFr': 'Voyages-personnes'}
    PPL_VISITS = 248  # (Person-visits) {'memberUomFr': 'Visites-personnes'}
    PPL = 249  # (Persons) {'memberUomFr': 'Personnes'}
    ...
    POL = 252  # (Policies) {'memberUomFr': 'Polices'}
    ...
    RATE_PER_100000_POP = 265  # (Rate per 100,000 population) {'memberUomFr': 'Taux pour 100 000 personnes'}
    RATES_PER_1000_FEMALES = 266  # (Rates per 1,000 females) {'memberUomFr': 'Taux pour 1 000 femmes'}
    RATES_PER_1000_POP = 267  # (Rates per 1,000 population) {'memberUomFr': 'Taux pour 1 000 personnes'}
    ...
    REC = 273  # (Records) {'memberUomFr': 'Disques'}
    ...
    AGE_SEX_STANDARDIZED_RATE_PER_100000_POP = 29  # (Age-sex-standardized rate per 100,000 population) {'memberUomFr': "Taux normalisé selon l'âge et le sexe pour 100 000 personnes"}
    TONNES_PER_THOUSAND_CURRENT_DOLLARS_OF_PROD = 290  # (Tonnes per thousand current dollars of production) {'memberUomFr': 'Tonnes par millier de dollars courants de production'}
    ...
    USA_DOLLARS = 297  # (United States Dollars) {'memberUomFr': 'Dollars des États-Unis'}
    USA_DOLLARS_1 = 298  # (United States dollars) {'memberUomFr': 'Dollars des États-Unis'}
    USA_DOLLARS_PER_CAN_DOLLAR = 299  # (United States dollars per Canadian dollar) {'memberUomFr': 'Dollars États-Unis par dollar canadien'}
    _1986_100 = 3  # (1986=100) {'memberUomFr': '1986=100'}
    AGE_STANDARDIZED_RATE_PER_100000_POP = 30  # (Age-standardized rate per 100,000 population) {'memberUomFr': "Taux normalisé selon l'âge pour 100 000 personnes"}
    UNITS = 300  # (Units) {'memberUomFr': 'Unités'}
    VEHIC_KILOMETRES = 301  # (Vehicle-kilometres) {'memberUomFr': 'Véhicule-kilomètres'}
    VEHIC = 302  # (Vehicles) {'memberUomFr': 'Véhicules'}
    ...
    MICROGRAMS_PER_LITRE = 310  # (Micrograms per litre (µg/L)) {'memberUomFr': 'Microgrammes par litre (µg/L)'}
    MINUTES_PER_DAY = 311  # (Minutes per day) {'memberUomFr': 'Minutes par jour'}
    NANOGRAMS_PER_MILLILITRE = 312  # (Nanograms per millilitre (ng/mL)) {'memberUomFr': 'Nanogrammes par millilitre (ng/mL)'}
    NANOMOLES_PER_LITRE = 313  # (Nanomoles per litre (nmol/L)) {'memberUomFr': 'Nanomoles par litre (nmol/L)'}
    ...
    LITRES_PER_PPL_PER_DAY = 318  # (Litres per person per day) {'memberUomFr': 'Litres par personne par jour'}
    TWENTY_FEET_EQUIVALENT_UNITS_1 = 319  # (Twenty feet equivalent units ) {'memberUomFr': 'Unités équivalent à vingt pieds '}
    AVG_HOURS_PER_DAY = 32  # (Average hours per day) {'memberUomFr': 'Moyenne des heures par jour'}
    ...
    NUM_OF_GROSS = 326  # (Number of gross) {'memberUomFr': 'Nombre en grosses'}
    ...
    VOLUME_IN_LITRES_OF_PURE_ALC = 330  # (Volume in litres of pure alcohol) {'memberUomFr': "Volume en litres d'alcool pur"}
    ...
    NUM_OF_PACKAGES = 336  # (Number of packages) {'memberUomFr': 'Nombre de paquets'}
    ...
    NUM_OF_DOZENS = 340  # (Number of dozens) {'memberUomFr': 'Nombre de douzaines'}
    ...
    NUM_OF_PAIRS = 344  # (Number of pairs) {'memberUomFr': 'Nombre de paires'}
    ...
    IDX_201612_100 = 347  # (Index, 201612=100) {'memberUomFr': 'Indice, 201612=100'}
    IDX_2012_100 = 348  # (Index, 2012=100) {'memberUomFr': 'Indice, 2012=100'}
    ...
    IDX_2014_100 = 351  # (Index, 2014=100) {'memberUomFr': 'Indice, 2014=100'}
    NANOGRAMS_PER_LITRE = 352  # (Nanograms per litre (ng/L)) {'memberUomFr': 'Nanogrammes par litre (ng/L)'}
    MICROMOLES_PER_MILLIMOLE = 353  # (Micromoles per millimole (µmol/mmol)) {'memberUomFr': 'Micromoles par millimole (µmol/mmol)'}
    MICROMOLES_PER_LITRE = 354  # (Micromoles per litre (µmol/L)) {'memberUomFr': 'Micromoles par litre (µmol/L)'}
    MILLIGRAMS_PER_LITRE = 355  # (Milligrams per Litre (mg/L)) {'memberUomFr': 'Milligrammes par litre (mg/L)'}
    MICROGRAMS_PER_CUBIC_METRE = 356  # (Micrograms per cubic metre (µg/m3)) {'memberUomFr': 'Microgrammes par mètre cube (µg/m3)'}
    ...
    MILLI_INTL_UNITS_PER_LITRE = 369  # (Milli-international units per litre) {'memberUomFr': 'Milli-units internationale par litre'}
    BIRDS = 37  # (Birds) {'memberUomFr': 'Oiseaux'}
    CONSTANT_DOLLARS = 370  # (Constant dollars) {'memberUomFr': 'Dollars constants'}
    NUM_OF_FARMS = 371  # (Number of farms) {'memberUomFr': "Nombre d'exploitations"}
    FARM_OPER = 372  # (Farm operators) {'memberUomFr': 'Exploitants agricoles'}
    IDX_2017_100 = 373  # (Index, 2017=100) {'memberUomFr': 'Indice, 2017=100'}
    IDX_2015_100 = 374  # (Index, 2015=100) {'memberUomFr': 'Indice, 2015=100'}
    _1997_CHAINED_DOLLARS = 375  # (1997 chained dollars) {'memberUomFr': 'En dollars enchaînés 1997'}
    NUM_IDX_OF_CHANGE = 376  # (Number, indices of change) {'memberUomFr': 'Nombre, indices de variation'}
    ...
    AVG_YEARS = 379  # (Average years) {'memberUomFr': 'Moyenne des années'}
    ...
    CHAINED = 382  # (Chained (2012) dollars per hour) {'memberUomFr': 'Dollars enchaînés (2012) par heure'}
    ...
    IDX_2016_100 = 386  # (Index, 2016=100) {'memberUomFr': 'Indice, 2016=100'}
    ...
    NANOMOLES_PER_MILLIMOLE = 394  # (Nanomoles per millimole (nmol/mmol)) {'memberUomFr': 'Nanomoles par millimole (nmol/mmol)'}
    ...
    AGE_STANDARDIZED_RATE_PER_100000_PPL_YEARS_AT_RISK = 397  # (Age-standardized rate per 100,000 person-years at risk) {'memberUomFr': 'Taux normalisés selon l’âge pour 100 000 années-personnes à risque'}
    IDX_2018_100 = 398  # (Index, 2018=100) {'memberUomFr': 'Indice, 2018=100'}
    ...
    IDX_202001_100 = 403  # (Index, 202001=100) {'memberUomFr': 'Indice, 202001=100'}
    ...
    IDX_VAL = 407  # (Index value (2019=0)) {'memberUomFr': 'Valeur de l’index (2019=0)'}
    ...
    GRAMS_PER_ONE_MILLION_PPL_PER_DAY = 411  # (Grams per one million people per day) {'memberUomFr': 'Grammes par million de personnes par jour'}
    KILONEWTONS = 412  # (Kilonewtons (kN)) {'memberUomFr': 'Kilonewtons (kN)'}
    FORCE_PER_UNIT_MASS = 413  # (Force per unit mass (m/s2)) {'memberUomFr': 'Force par unite de masse (m/s2)'}
    KILOWATT_PER_KILOGRAM = 414  # (Kilowatt per kilogram (kW/kg)) {'memberUomFr': 'Kilowatt par kilogramme (kW/kg)'}
    METERS_PER_SEC = 415  # (Meters per second (m/s)) {'memberUomFr': 'Mètres par seconde (m/s)'}
    MILLIGRAMS_PER_CUBIC_CENTIMETER = 416  # (Milligrams per cubic centimeter (mg/cm³)) {'memberUomFr': 'Milligrammes par centimètre cube (mg/cm³)'}
    SQUARE_MILLIMETERS = 417  # (Square millimeters (mm2)) {'memberUomFr': 'Millimètres carré (mm2)'}
    TRVL = 418  # (Travellers) {'memberUomFr': 'Voyageurs'}
    VISITORS = 419  # (Visitors) {'memberUomFr': 'Visiteurs'}
    BUSHELS = 42  # (Bushels) {'memberUomFr': 'Boisseaux'}
    MILLIMOLES_PER_LITRE_1 = 420  # (Millimoles per litre (mmol/L)) {'memberUomFr': 'Millimoles par litre (mmol/L)'}
    WATTS_PER_KILOGRAM = 421  # (Watts per kilogram (W/kg)) {'memberUomFr': 'Watts par kilogramme (W/kg)'}
    AVG = 422  # (Average) {'memberUomFr': 'Moyenne'}
    AVG_NUM = 423  # (Average number) {'memberUomFr': 'Nombre moyen'}
    RATE_PER_1000_MARRIED_PPL = 424  # (Rate per 1,000 married persons) {'memberUomFr': 'Taux pour 1 000 personnes mariées'}
    _2020_CONSTANT_DOLLARS = 425  # (2020 constant dollars) {'memberUomFr': 'Dollars constants de 2020'}
    IDX_2019_100 = 426  # (Index, 2019=100) {'memberUomFr': 'Indice, 2019=100'}
    _202204_100 = 427  # (202204=100) {'memberUomFr': '202204=100'}
    PPL_IN_THOUSANDS = 428  # (Persons in thousands) {'memberUomFr': 'Personnes en milliers'}
    ...
    IDX_2020_100 = 430  # (Index, 2020=100) {'memberUomFr': 'Indice, 2020=100'}
    AVG_PERCENTAGE = 431  # (Average percentage) {'memberUomFr': 'Pourcentage moyen'}
    RATE_PER_1000_PPL_OF_THE_SAME_MARITAL_STS = 432  # (Rate per 1,000 persons of the same marital status) {'memberUomFr': 'Taux pour 1000 personnes du même état matrimonial'}
    FEET = 433  # (Feet) {'memberUomFr': 'Pieds'}
    IDX_2021_100 = 434  # (Index, 2021=100) {'memberUomFr': 'Indice, 2021=100'}
    ...
    BUS = 44  # (Businesses) {'memberUomFr': 'Entreprises'}
    ...
    MILLIGRAMS_PER_ONE_THOUSAND_PPL_PER_DAY = 442  # (Milligrams per one thousand people per day (mg/1000 people/day)) {'memberUomFr': 'Milligrammes pour mille personnes par jour (milligrammes/1000 personnes/jour)'}
    COUNT_PER_HECTARE = 443  # (Count per hectare) {'memberUomFr': 'Nombre par hectare'}
    AVG_NUM_OF_WEEKS = 444  # (Average number of weeks) {'memberUomFr': 'Nombre moyen de semaines'}
    ...
    RATE_PER_1000_POP = 448  # (Rate per 1,000 population) {'memberUomFr': 'Taux pour 1 000 habitants'}
    ...
    IDX_2023_100 = 451  # (Index, 2023=100) {'memberUomFr': 'Indice, 2023=100'}
    ...
    IDX_202407_100 = 454  # (Index, 202407=100) {'memberUomFr': 'Indice, 202407=100'}
    ...
    MILLIGRAM_PER_CUBIC_METER = 457  # (Milligram per cubic meter (mg/m3)) {'memberUomFr': 'Milligramme par mètre cube (mg/m3)'}
    AVAILABLE = 458  # (available) {'memberUomFr': 'available'}
    DISPONIBLE = 459  # (disponible) {'memberUomFr': 'disponible'}
    CAN_100 = 46  # (Canada = 100) {'memberUomFr': 'Canada = 100'}
    CAN_DOLLARS = 47  # (Canadian dollars) {'memberUomFr': 'Dollars canadiens'}
    CAN_DOLLARS_PER_HUNDREDWEIGHT = 48  # (Canadian dollars per hundredweight) {'memberUomFr': 'Dollars canadiens par poids de cent livres'}
    CAN_DOLLARS_PER_UNIT_OF_FGN_CURRENCY = 49  # (Canadian dollars per unit of foreign currency) {'memberUomFr': 'Dollars canadiens par unité de devise étrangère'}
    ...
    CHILD = 65  # (Children) {'memberUomFr': 'Enfants'}
    CIGARETTES = 66  # (Cigarettes) {'memberUomFr': 'Cigarettes'}
    CIGARS = 67  # (Cigars) {'memberUomFr': 'Cigars'}
    CLAIMS = 68  # (Claims) {'memberUomFr': 'Demandes'}
    CORP = 69  # (Corporations) {'memberUomFr': 'Corporations'}
    _1992_100 = 7  # (1992=100) {'memberUomFr': '1992=100'}
    CORP_1 = 70  # (Corporations) {'memberUomFr': 'Sociétés'}
    CRUDE_RATE_PER_100000_POP = 71  # (Crude rate per 100,000 population) {'memberUomFr': 'Taux brut pour 100 000 personnes'}
    ...
    CUST = 76  # (Customers) {'memberUomFr': 'Clients'}
    DAYS = 77  # (Days) {'memberUomFr': 'Jours'}
    DEG_CELSIUS = 78  # (Degrees Celsius) {'memberUomFr': 'Degrés Celsius'}
