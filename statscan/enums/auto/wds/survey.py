...
#     date: 2025-10-09T16:56:32.561869+00:00
...
class Survey(Enum):
    ...
    LIV_WITH_A_LIFE_LIMIT_ILLNESS_ACCESS_TO_CARE_AND_REL_EXP = 5416  # Living with a Life-limiting Illness: Access to Care and Related Experiences (LLLI-ACRE)  // Vivre avec une maladie limitant l'espérance de vie : accès aux soins et expériences connexes (VMLEV-ASEC)
    ...
    NAT_RES_SAT_ACCT = 5438  # Natural Resources Satellite Account - Critical Minerals Extension  // Compte satellite des ressources naturelles - extension des minéraux critiques
