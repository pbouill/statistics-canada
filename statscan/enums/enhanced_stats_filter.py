"""
Enhanced statistics filter enums with comprehensive dimension values.
This extends the basic stats_filter.py with more complete enum coverage.
"""
...
@dataclass
class EnhancedStatsFilter:
    """Enhanced statistics filter with comprehensive dimension support."""
    ...
    def from_str(cls, filter_str: str) -> Self:
        """Create an EnhancedStatsFilter instance from a string representation."""
        return cls.from_parts(*filter_str.split('.'))
    
    @classmethod
    def from_parts(cls, gender_str: str, cpc_str: str, stattype_str: str) -> Self:
        """Create an EnhancedStatsFilter instance from individual parts."""
        return cls(
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'characteristic': {
                'value': self.census_profile_characteristic.value if self.census_profile_characteristic else None,
                'name': self.census_profile_characteristic.name if self.census_profile_characteristic else None,
                'description': self.census_profile_characteristic.description if self.census_profile_characteristic else None,
                'category': self.census_profile_characteristic.category if self.census_profile_characteristic else None
            },
            'statistic_type': {
                ...
                'description': self.statistic_type.description if self.statistic_type else None
            }
        }
...
class CommonFilters:
    ...
    @staticmethod
    def population_total() -> EnhancedStatsFilter:
        """Total population count for all genders."""
        return EnhancedStatsFilter(
    ...
    @staticmethod
    def population_by_gender(gender: Gender) -> EnhancedStatsFilter:
    ...
    @staticmethod
    def median_age_total() -> EnhancedStatsFilter:
    ...
    @staticmethod
    def household_income_median() -> EnhancedStatsFilter:
    ...
    @staticmethod
    def total_dwellings() -> EnhancedStatsFilter:
