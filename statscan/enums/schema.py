...
class SACType(Enum):
    ...
    MIZ_MODERATE = (
        5  # Census Subdivision in a Moderate Metropolitan Influenced Zone (MIZ)
    )
    ...
    TERRITORY_OUTSIDE_CA = (
        8  # Census Subdivision in a Territory outside a Census Agglomeration
    )
