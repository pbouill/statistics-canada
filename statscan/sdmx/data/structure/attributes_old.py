...
from statscan.sdmx.data.structure.dimension.observation import Observation
...
class Attribute(Base):
    ...
    def get_value_by_name(self, name: str, language: str = 'en') -> Optional[AttributeValue]:
...
class Attributes(Base):
    ...
    observation: list[Attribute] = []  # Changed from Observation to Attribute
